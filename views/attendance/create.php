<?php
/**
 * Vue : ajout manuel d'un pointage.
 */
$employees = $employees ?? [];
$errors    = $errors    ?? [];
$input     = $input     ?? [];
...
<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
    <div>
        <h4 class="text-xl font-semibold text-gray-900"><i class="fas fa-user-plus text-blue-600 mr-2"></i>Ajouter un pointage</h4>
...
<div class="bg-white rounded-lg shadow-sm border border-gray-200 max-w-2xl">
    <div class="p-6">
        <form method="post" action="index.php?controller=attendance&action=create" class="flex flex-col gap-4">
