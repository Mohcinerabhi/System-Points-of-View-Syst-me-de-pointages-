<?php
/**
 * Vue : édition d'un horaire de travail.
 */
$schedule = $schedule ?? [];
$errors   = $errors   ?? [];
$days = [
...
<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
    <h4 class="text-xl font-semibold text-gray-900">Modifier l'horaire</h4>
...
<div class="bg-white rounded-lg shadow-sm border border-gray-200">
    <form method="post" action="index.php?controller=schedules&action=edit&id=<?= (int)($schedule['id'] ?? 0) ?>">
        ...
        <div class="p-6">
            ...
            <div class="mb-4 flex items-center gap-2">
                <input type="checkbox" name="is_active" value="1" id="is_active_edit" <?= !empty($schedule['is_active']) ? 'checked' : '' ?> class="w-4 h-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                <label for="is_active_edit" class="text-sm font-medium text-gray-700">Actif</label>
            </div>
