...
<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
    <h4 class="text-xl font-semibold text-gray-900">Modifier le terminal</h4>
...
<div class="bg-white rounded-lg shadow-sm border border-gray-200">
    <form method="post" action="index.php?controller=terminals&action=edit&id=<?= (int)($terminal['id'] ?? 0) ?>">
        <div class="p-6">
            ...
            <div class="mb-4">
                ...
                <select name="protocol" id="protocol_select_edit" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    <option value="">-- Par défaut (ISAPI) --</option>
                </select>
            </div>
            <div id="isup_fields_edit" class="hidden" style="display:none">
                <div class="mb-4">
            ...
            <div class="mb-4 flex items-center gap-2">
                <input type="checkbox" name="sync_enabled" value="1" id="sync_enabled_edit" <?= !empty($terminal['sync_enabled']) ? 'checked' : '' ?> class="w-4 h-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                <label for="sync_enabled_edit" class="text-sm font-medium text-gray-700">Synchronisation activée</label>
            </div>
            <div class="mb-4">
...
<script>
(function(){
    var sel = document.getElementById('protocol_select_edit');
    var box = document.getElementById('isup_fields_edit');
    if (!sel || !box) return;
    function toggle(){
